...
public class HexWorld {
    ...
    /**
     *  x coordinate of the leftmost tile in the ith
     ...
     * xxxx
     *  <-- i = 2, starts 2 spots to the left of the bottom of the hex
     * xxxx
     *
    ...
    public static void main(String[] args) {
        ...
        HexWorld.addHexagon(world,Position,7,Tileset.FLOWER);
